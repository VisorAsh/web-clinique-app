...
interface FooterProps {
  ...
  liste_departements: Departement[];
}

export default function Footer({ liste_coordonnee, liste_departements }: FooterProps) {
  return (
    <footer className="bg-blue-50 py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <h4 className="text-lg font-semibold mb-4">Départements</h4>
            <div className="w-12 h-1 bg-blue-600 mb-4"></div>
            <ul className="space-y-2">
              {liste_departements.map((dep, index) => (
                <li key={index}>
                  <a href="#" className="text-gray-600 hover:text-blue-600">{dep.Titre}</a>
                </li>
              ))}
            </ul>
          </div>
            ...
            <div key={index}>
              ...
              <div className="mb-6">
                <div className="flex items-start mb-2">
                  ...
                  <div>
                    <p className="text-sm text-gray-500">Disponible 24/24 - 7/7</p>
                    <a href={`mailto:${coo.Mail}`} className="text-gray-700 hover:text-blue-600 font-medium">{coo.Mail}</a>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-sm text-gray-500">Lun - Ven : 07:00 - 23:00</p>
                    <a href={`tel:${coo.Telephone}`} className="text-gray-700 hover:text-blue-600 font-medium">{coo.Telephone}</a>
                  </div>
                </div>
              </div>
